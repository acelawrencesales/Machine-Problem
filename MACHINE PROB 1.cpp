...
int main()
{
	...
	//Name of the students and their scores
	...
	for (int i = 0; i < array; i++)
	{
		...
		//For inputting students' name	
		cout << "Enter Name of (" << i + 1 << ") Student \n[SURNAME.FN.SN.MI] : "; cin >> str[i];
		
		//For encoding students' individual report scores
		...
		//For computing and outputting individual report scores
		indiv = (sum / 10) * .15;
		cout << "Total (15%): " << indiv << "\n" "\n";
	
		//For inputting students' group report scores
		...
		//For computing and outputting students' group report scores
		group = (sum1 / 10) * .25;
		cout << "Total (25%): " << group << "\n" "\n";
		
		//For inputting students' quizzes grades
		cout << "Quizzes ( / 100): " << "\n";
		cout << "1: "; cin >> quiz1;
		...
		//For computing students' exams scores
		totalf = writf + pracf;
	...
	//For rearranging the top 10 students' in class
